  ...
  <svg className={classes} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 234" preserveAspectRatio="xMinYMin meet">
    <g id="Layer_2_1_">
      ...
      <g id="Outlined_Mnemonics_Logos">
        <g id="Ps">
          <path class="st1" fill="#f2f4f5" d="M54,164.1V61.2c0-0.7,0.3-1.1,1-1.1c1.7,0,3.3,0,5.6-0.1c2.4-0.1,4.9-0.1,7.6-0.2c2.7-0.1,5.6-0.1,8.7-0.2
          ...
          <path class="st1" fill="#f2f4f5" d="M192,106.9c-3-1.6-6.2-2.7-9.6-3.4c-3.7-0.8-7.4-1.3-11.2-1.3c-2-0.1-4.1,0.2-6,0.7c-1.3,0.3-2.4,1-3.1,2
